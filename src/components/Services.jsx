...
const Services = () => {
  ...
  >
    ...
    <h5 className="vertical-timeline-element-subtitle" style={{marginTop: '0.5rem'}}>
      Tech - React Native, React JS, Jest
    </h5>
    ...
    <ul className='text-slate-500' style={{ listStyle: 'outside'}}>
      ...
      <li>Handling the different version of components</li>
      <li>Migrate consumers app with the latest version of componets
</li>
    </ul>
  </VerticalTimelineElement>
  <VerticalTimelineElement
  ...
  >
    ...
    <h6 className="vertical-timeline-element-subtitle">Role - UI Developer</h6>
    <h5 className="vertical-timeline-element-subtitle" style={{marginTop: '0.5rem'}}>
    Tech - ReactJS, Storybook, TypeScript, Jest, springboot, docker, kubernetes
      </h5>
    <p style={{marginTop: '0.5rem', marginBottom: '0.5rem'}}>
    ...
    <ul className='text-slate-500' style={{ listStyle: 'outside'}}>
      ...
      <li>Created new design in storybooks in Typescript</li>
      <li>Took initiatives to increase the code coverage</li>
      <li>Cultivated other backend devs in UI
</li>
      <li>Took initiatives to create tech debt card mainly for the cleanup</li>
  ...
  >
    ...
    <p style={{marginTop: '0.5rem', marginBottom: '0.5rem'}}>
    Worked in Customer engagement software whicj tracks all investment accounts under one platform
    </p>
    <ul className='text-slate-500' style={{ listStyle: 'outside'}}>
